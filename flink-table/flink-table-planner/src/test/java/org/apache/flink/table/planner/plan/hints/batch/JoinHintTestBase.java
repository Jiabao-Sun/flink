...
public abstract class JoinHintTestBase extends TableTestBase {
    ...
    void testJoinHintWithUnknownTable() {
        ...
        assertThatThrownBy(() -> verifyRelPlanByCustom(String.format(sql, getTestSingleJoinHint())))
                 .hasMessage("The options of following hints cannot match the name of input tables or views: \n`%s` in `%s`",
    ...
    void testJoinHintWithUnknownView() {
        ...
        assertThatThrownBy(() -> verifyRelPlanByCustom(String.format(sql, getTestSingleJoinHint())))
                .hasMessage(String.format("The options of following hints cannot match the name of input tables or views: \n`%s` in `%s`",
    ...
    void testJoinHintsWithMultiHintsThrowException() {
        ...
        assertThatThrownBy(() -> verifyRelPlanByCustom(String.format(sql, getTestSingleJoinHint(), getTestSingleJoinHint())))
                .hasMessage("SQL parse failed.")
